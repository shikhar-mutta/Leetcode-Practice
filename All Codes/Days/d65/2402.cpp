    ...
    // Sort meetings by start; free up rooms whose meetings ended; use a free room if available, else delay to the earliest-freeing room. Track usage count per room.   
    class Solution
    {
    public:
